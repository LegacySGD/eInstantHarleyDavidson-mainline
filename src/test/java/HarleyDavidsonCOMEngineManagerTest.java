...
public class HarleyDavidsonCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HarleyDavidsonCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HarleyDavidsonIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HarleyDavidsonIW/InitOutcome.xml").getDocumentElement();
	...
	@Test
	public void test_buy_200x_2000000CreditsWin_RevealThreeTimes()
		throws Exception
	{
		Element playerInput;
		int pricePoint = 200;
		...
		assertEquals("Wager", JXPathUtil.getString(outcome, "//NextStage/text()"));
		assertSettledPendingPayout(outcome, pricePoint, 0, 2000000);
	}
	...
	@Test
	public void test_try_200x_2000000CreditsWin()
			throws Exception
	{
		Element playerInput;
		int pricePoint = 200;
